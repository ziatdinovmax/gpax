...
from gpax.models.vi_mtgp import viMultiTaskGP
...
def test_fit_multitask(data_kernel, num_tasks, num_latents):
    ...
    m = viMultiTaskGP(1, data_kernel, num_latents=num_latents, shared_input_space=False)
...
def test_fit_multitask_meanfn():
    ...
    m = viMultiTaskGP(1, 'Matern', num_latents=2, shared_input_space=False,
...
def test_sample_kernel_custom_lscale_prior():
    ...
    m1 = viMultiTaskGP(1, 'RBF', num_latents=2, num_tasks=2, rank=2)
    with numpyro.handlers.seed(rng_seed=1):
        lscale1 = m1._sample_kernel_params()["k_length"]
    m2 = viMultiTaskGP(1, 'RBF', num_latents=2, num_tasks=2, rank=2, 
