# Gpax
GPax is a small Python package for phyiscs-based Gaussian processes (GPs) built on top of NumPyro and JAX. It is a work in progress and more models/approaches will be added in the near future.
